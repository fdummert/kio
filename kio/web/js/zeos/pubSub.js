define(["dojo/_base/unload", "dojox/cometd", "dojox/cometd/ack", "dojo/domReady!"], function(unloader, cometDInstance) {
    var PubSub = function() {
        if ((this instanceof PubSub) === false)
            throw "PubSub must be instantiated: new PubSub()";
        ...
        var cometD = null;
        var that = this;
        if (PubSub.prototype.COMET_D == null) {
            PubSub.prototype.COMET_D = cometDInstance;
        ...
        this.connect = function(credentials, abortOnConnectionError) {
            ...
            if (credentials != null) {
                handshakeProps = {
                    ext : {
                        "de.zeos.cometd.security" : {
                            username : credentials.username,
                            password : credentials.password,
                            className : "de.zeos.cometd.security.Credentials"
                        }
                    }
                };
            }
