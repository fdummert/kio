...
import de.zeos.cometd.security.service.SecurityService;
...
public class AuthSecurityPolicy implements SecurityPolicy {
    ...
    public boolean canHandshake(BayeuxServer server, ServerSession session, ServerMessage message) {
        ...
        Credentials credentials = ext == null ? null : (Credentials) ext.get(AUTH_KEY);
        try {
            Authorization auth = this.securityService.authenticate(credentials);
